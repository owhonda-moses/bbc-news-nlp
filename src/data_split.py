...
OUTPUT_TRAINING_PATH = os.path.join(DATA_PATH, 'train_data.csv')
OUTPUT_TEST_PATH = os.path.join(DATA_PATH, 'test_samples.csv')
TEST_SET_SIZE = 0.05 
...
def main():
    ...
    print(f"  Gold-standard articles saved: {len(gold_standard_df)} samples")
